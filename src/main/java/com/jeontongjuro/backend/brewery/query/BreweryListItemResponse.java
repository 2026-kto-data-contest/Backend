 ...
 * <p>
 * 대표 이미지는 tour_content(TourAPI 캐시)의 first_image를 우선 사용하고, 없으면 breweryId에 대응하는
 * 정적 양조장 사진을 fallback으로 사용한다({@link MainImageResponse}). 매핑된 사진도 없으면 mainImage=null.
